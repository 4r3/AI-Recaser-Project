...
if __name__ == "__main__" :
    ...
    # Recaser.recase("You love unicorns so much! And you, do you want to have sex with unicorns? Oh, yes James!", RecaserMethod.CRF_CHAR, ["corpus_11/corpus", "corpus_12/corpus"])
    # Recaser.recase("i love unicorns! and you, do you like unicorns? yes!", RecaserMethod.DNN_WORD,"corpus_1/corpus")
